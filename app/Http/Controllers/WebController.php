...
class WebController extends Controller
{
    ...
    public function saveUserInfo(Request $request)
    {
        ...
        // Validate body fat percentage (should be between 2% and 60%)
        $bodyFat = round($bodyFat, 2);
        if ($bodyFat < 2) {
            $bodyFat = 2; // Minimum healthy body fat
        } elseif ($bodyFat > 60) {
            $bodyFat = 60; // Maximum body fat
        }
    ...
    private function cleanJsonResponse($response)
{
    ...
    public function aiPrompt($day, $userData = [])
    {
        ...
        return "Nutritionist Day {$day}. User: {$user['gender']},{$user['weight']}kg,BMI {$user['bmi']},BMI Overview {$user['bmi_overview']},TDEE {$user['tdee']}
            ...
            9. You MUST include fruits from the allowed list ONLY, using the following exact values per 100g:
               - Apple|57.81|0.26|13.81|0.17
               - Avocado|174.06|2|8.53|14.66
               - Banana|98.69|1.09|22.84|0.33
               - Blackberry|48.41|1.39|9.61|0.49
               - Cantaloupe|37.71|0.84|8.16|0.18
               - Dragon Fruit|50.6|1.1|11.1|0.56
               - Grapes|69.9|0.72|18.1|0.16
               - Kiwi|67.88|1.14|14.66|0.52
               - Mango|66.62|0.82|14.98|0.38
               - Orange|69.9|1.3|15.5|0.3
               - Papaya|47.5|0.47|10.82|0.26
               - Passion Fruit|97.6|2.2|23.4|0.4
               - Pineapple|55.72|0.54|13.12|0.12
               - Pomegranate|92.01|1.67|18.7|1.17
               - Strawberry|36.1|0.67|7.68|0.26
               - Watermelon|33.99|0.61|7.55|0.15
            10. If goal is lose, you MUST add at least 2 snack meals containing fruits or light protein to avoid hunger.
            11. If goal is gain, you MUST add at least 1 snack meal that includes a fruit or calorie-dense food (e.g. banana, avocado).
            12. Sweets are allowed in moderation. Use only from the list below:
               - CHOCOLATE BROWNIE|200|2.5|14|14|6.3 (45g)
               - MARBLE CAKE LOAF SLICE|204.7|1.9|21.3|12.4|3.99 (50g)
               - CARROT CAKE LOAF SLICE|140|3.8|14.3|7.1|3.99 (50g)
               - CINNAMON RAISIN ROLL|232|3.3|25|13.3|4.725 (80g)
               - DANISH FOREST BERRIES|214|3.1|20.2|12.8|4.725 (80g)
               - DOUBLE DARK CHOCOLATE COOKIE (2 PCS X 15g)|62.4|2|1.1|5.4|3.99 (30g)
               - GF SOFT COOKIE CHOCOLATE CHIP|106|3.1|2.7|8.2|4.095 (50g)
               - CROISSANT|187.5|2.4|16.4|12.5|4.62 (50g)
               - MUFFIN MINI GF RASPBERRY DARK CHOCOLATE|208|3|23.2|11.1|7.0875 (70g)
               - DARK CHOCOLATE CRANBERRY BALL|137|6.4|16|3.2|6.3 (40g)
               - MUFFIN MINI GF APPLE CINNAMON & CHIA SEEDS|218|2.9|23.2|12.3|6.384 (70g)
               - DARK CHOCOLATE ALMOND CHOCO NIBS POWER BAR|137|6.4|16|3.2|6.3 (40g)
               - GRANOLA BAR|190|4.6|23|8.3|6.3 (45g)
            13. Alternate sweet intake to avoid excess: If today includes a dessert, the next day should prioritize fruits and protein-based snacks only (no sweets).

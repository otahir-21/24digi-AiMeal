    ...
    <div class="rounded-2xl overflow-hidden mt-7">
        <table class="w-full rounded p-5">
            ...
            <tbody class="bg-[#7F5AF0]/10">
                @forelse ($sauces as $index => $sauce)                    
                    <tr>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center">{{ $index + 1 }}</td>
                        <td class="border-b !border-gray-400 p-3 text-[14px]">{{$sauce->name}}</td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{$sauce->unit}} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{$sauce->price}} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{$sauce->calories}} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{$sauce->protein}} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{$sauce->carbs}} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{$sauce->fats_per_100g}} </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="8">

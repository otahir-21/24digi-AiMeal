            ...
            <tbody class="bg-[#7F5AF0]/10">
                @forelse ($ingredients as $index => $ingredient)
                    <tr>
                        ...
                        <td class="border-b !border-gray-400 p-3 text-[14px]">{{ $ingredient->name }}</td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{ $ingredient->unit }} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{ $ingredient->price }} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{ $ingredient->calories }} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{ $ingredient->protein }} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{ $ingredient->carbs }} </td>
                        <td class="border-b !border-gray-400 p-3 text-[14px] text-center"> {{ $ingredient->fats_per_100g }} </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="8">
            ...
            @csrf <div class="mb-3">
                <div class="flex justify-between">
                    ...
                    <a class="font-semibold text-[#7F5AF0] hover:underline"
                        href="{{ asset('assets/template-sheet.csv') }}">
                        Download template
                    </a>
                </div>
